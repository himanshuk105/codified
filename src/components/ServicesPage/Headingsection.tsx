...
// import services from '../../../public/services-image.jpg' // Adjust the path as necessary
export const HeadingSection = ({ hero1 }: any) => {
  ...
  return (
    <>
      <div
        className="box-border relative z-10 text-center flex flex-col items-center justify-center gap-6 py-40  bg-[#F8F7F3] px-6"
        style={{
      ...
      >
        ...
        {hero1.button.map((d: any) => (
          <motion.button
            ...
            className="border-2 border-[#4993cd] bg-[#4993cd] hover:border-[#3ca9ff]  text-[#fff] px-6 py-3 rounded-md text-sm sm:text-base shadow-lg mt-6 flex items-center justify-center gap-3 font-extrabold hover:bg-[#3ca9ff] hover:text-white transition-colors duration-200"
            ref={scope}
          >
