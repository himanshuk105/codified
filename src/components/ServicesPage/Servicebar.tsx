...
export const Servicebar = ({ sections }: any) => {
  ...
  return (
    ...
    <div className="hidden  m-auto lg:flex flex-row gap-4 border border-[#222222] items-center justify-between bg-white px-7 py-3 z-50 rounded-2xl lg:sticky top-0">
